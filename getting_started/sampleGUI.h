...
//
GLfloat step = 0;
GLfloat thetaSpinner = 0.f;
GLfloat phiSpinner = 0.f;
GLfloat ballMassSpinner = 1.f;
GLfloat powderMassSpinner = 0.01f;
GLfloat dtSpinner = 0.01f;
GLfloat draggCoeffSpinner = 1.f;
GLfloat springMassSpinner = 1.f;
GLfloat springConstSpinner = 1.f;
GLfloat springDampingSpinner = 1.f;
